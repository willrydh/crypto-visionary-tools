    ...
    <div className="min-h-screen py-8 md:py-12 px-4 sm:px-6 lg:px-8 max-w-3xl mx-auto animate-fade-in relative">
      ...
      <div className="relative z-10 mt-20 md:mt-16"> {/* Increased top margin for mobile */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <Button 
            variant="outline" 
            className="relative h-20 md:h-16 backdrop-blur-sm bg-black text-white hover:bg-black/90 border-black"
          ...
          <Button 
            variant="outline" 
            className="relative h-20 md:h-16 backdrop-blur-sm bg-white text-black hover:bg-gray-100 border-gray-300"
          ...
          <Button 
            variant="outline" 
            className="relative h-20 md:h-16 backdrop-blur-sm bg-[#635BFF] text-white hover:bg-[#5851E1] border-[#635BFF]"
