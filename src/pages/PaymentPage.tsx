    ...
    <div className="min-h-screen py-8 md:py-12 px-4 sm:px-6 lg:px-8 max-w-3xl mx-auto animate-fade-in relative">
      ...
      <div className="relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <Button 
            variant="outline" 
            className="relative h-16 backdrop-blur-sm bg-card/80"
          ...
          >
            <div className="absolute inset-0 flex items-center justify-center">
              <svg viewBox="0 0 24 24" className="w-6 h-6" fill="currentColor">
                <path d="M21.435 10.7h-7.2v2.7h4.173c-.386 1.99-2.112 3.483-4.173 3.483-2.485 0-4.5-2.015-4.5-4.5s2.015-4.5 4.5-4.5c1.065 0 2.037.374 2.803 1.001l1.935-1.935C17.63 5.617 16.035 4.95 14.235 4.95c-3.866 0-7.009 3.142-7.009 7.009s3.142 7.009 7.009 7.009c3.866 0 7.009-3.142 7.009-7.009 0-.435-.045-.86-.131-1.259H21.435z" />
              </svg>
