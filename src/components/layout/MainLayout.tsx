  ...
  return (
    <SidebarProvider defaultOpen={!isMobile}>
      <div className={`min-h-screen flex w-full overflow-x-hidden ${isTradingPage ? 'trading-page' : ''}`}>
        ...
        >
          <SidebarHeader className="p-4 mt-8"> {/* Increased mt-8 for more top spacing */}
        ...
        <div className="flex-1 flex flex-col w-full md:ml-64 overflow-x-hidden">
          <TopHeader />
          <main className="flex-1 overflow-auto pt-safe has-dynamic-island pb-safe z-10 overflow-x-hidden mt-8"> {/* Increased to mt-8 from mt-6 */}
