    ...
    <div className="py-12 px-4 md:px-6 bg-muted/50">
      <div className="text-center mb-10">
        ...
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Stay connected to the markets with ProfitPilot on iOS, Android and macOS.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
        ...
        <Card className="overflow-hidden border-primary/20 bg-primary/5">
          <CardContent className="p-8 flex flex-col items-center text-center">
            ...
            <h3 className="text-xl font-bold mb-2">ProfitPilot for Android</h3>
            <p className="mb-6 text-muted-foreground">
              Experience the full power of ProfitPilot on Android. Perfect for traders on the move.
            </p>
            <Button className="w-full">
